        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="othertitle" placeholder="Book other title" class="form-control" type="text">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="otherauthor" placeholder="Book Author" class="form-control" type="text">
